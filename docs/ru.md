...
> **ƒ** &nbsp;Nicolay B. aka RD_AAOW, Соля́ников Я.; 17.08.2024; 1:32

# Содержание
- [Общие сведения о программе](#section-1)
- [Видеоруководство](https://youtube.com/watch?v=QiOMIN4aE-Q)
...
- [Меню программы](#section-14)
    ...
    - [«Извлечь из изображения»](#section-22)
    - [«Настройки программы»](#section-23)
    - [«Выход»](#section-24)
    - Операции
    - [«Добавить кривую или объект»](#section-26)
    - [«Параметрическое добавление кривых»](#section-27)
    - [«Выбор столбцов данных кривой»](#section-28)
    - [«Совместить кривые или объекты»](#section-29)
    - [«Удалить кривые или объекты»](#section-30)
    - [«Редактировать данные диаграммы»](#section-31)
    - [«Загрузить стиль»](#section-32)
    - [«Сохранить стиль»](#section-33)
    - [«Сбросить стиль»](#section-34)
    - [«Сохранить шаблон добавления кривых»](#section-35)
    - [«Заменить шаблон добавления кривых»](#section-36)
    - [«Сбросить шаблон добавления кривых»](#section-37)
    - Дополнительно
    - [«Соединить таблицы»](#section-39)
    - [«Создать векторный рисунок»](#section-40)
    - Помощь
    - [«О программе / справка»](#section-42)
    - [Пункт меню с выбором языка интерфейса](#section-43)
    - [«Ассоциировать файлы»](#section-44)
- [Аппаратно-программные требования и комплектация программы](#section-45)
    - Комплектация программы
    - [Создаваемые файлы и директории](#section-47)
    - [Поддерживаемые форматы данных](#section-48)
    - [Поддержка форматов Microsoft Office Excel](#microsoft-office-excel)
    - [Работа с программой из командной строки](#section-49)
- [Ограничения и стандартные значения параметров](#section-50)
- [Спецификации форматов файлов](#section-51)
    ...
    - [Файлы, из которых необходимо извлечь данные](#section-52)
...
<img src="/GeomagDataDrawer/img/2_01_ru.png" />
...
&#x25B6; Кнопки добавления (<img src="/GeomagDataDrawer/img/2_70.png" />) и удаления (<img src="/GeomagDataDrawer/img/2_73.png" />) кривых и дополнительных объектов.

&#x25B6; Кнопка скрытия / отображения (<img src="/GeomagDataDrawer/img/2_60.png" />) кривых и объектов.
...
&#x3000;&#x25B7; в каком диапазоне абсцисс и ординат следует построить кривую, а также требуется ли транспонирование (вкладка <img src="/GeomagDataDrawer/img/2_33.png" />);

&#x3000;&#x25B7; как следует расположить изображение кривой и/или объекта на листе, а также какого оно должно быть размера (вкладка <img src="/GeomagDataDrawer/img/2_34.png" />);

&#x3000;&#x25B7; требуется ли вручную установить расположение подписей диаграммы и название рисунка, или программа должна установить их автоматически (вкладка <img src="/GeomagDataDrawer/img/2_36.png" />);

&#x3000;&#x25B7; как следует отображать координатные оси диаграммы (вкладка <img src="/GeomagDataDrawer/img/2_46.png" />);

&#x3000;&#x25B7; как следует отображать координатную сетку диаграммы (вкладка <img src="/GeomagDataDrawer/img/2_47.png" />);

&#x3000;&#x25B7; как следует отображать подписи диаграммы (вкладка <img src="/GeomagDataDrawer/img/2_48.png" />);

&#x3000;&#x25B7; как следует отображать линии кривых диаграммы (вкладка <img src="/GeomagDataDrawer/img/2_49.png" />).
...
в Проводнике Windows, т.е. с помощью левой кнопки мыши и клавиш `[Ctrl]` и `[Shift]`. Таким образом, пользователь может производить тонкую
...
и объектов. Для этой функции доступна горячая клавиша, см. раздел «[Меню программы](#section-14)» данного руководства.
При этом будет вызвано окно параметров добавления.

<img src="/GeomagDataDrawer/img/2_03_ru.png" />
...
и объектов в списке для одновременного удаления. Для этой функции доступна горячая клавиша, см. раздел
...
Средняя кнопка мыши позволяет выделить кривые
и объекты для настройки. Для этого необходимо нажать кнопку и, удерживая её, в поле построения диаграммы выделить зону, в которой находятся
...
<img src="/GeomagDataDrawer/img/2_50_ru.png" />
...
<img src="/GeomagDataDrawer/img/2_37.png" /> и <img src="/GeomagDataDrawer/img/2_38.png" />, что будет соответствовать
...
<img src="/GeomagDataDrawer/img/2_51_ru.png" />
...
<img src="/GeomagDataDrawer/img/2_53_ru.png" />
...
<img src="/GeomagDataDrawer/img/2_54_ru.png" />
...
и относительное расположение, указать формат отображения чисел на шкалах (обычный или экспоненциальный).

Возможен выбор *автоопределения* для числа делений.
...
<img src="/GeomagDataDrawer/img/2_55_ru.png" />
...
<img src="/GeomagDataDrawer/img/2_56_ru.png" />
...
<img src="/GeomagDataDrawer/img/2_57_ru.png" />
...
Главное меню представлено пунктами, описанными ниже. В скобках указаны «горячие клавиши», с помощью которых можно вызвать соответствующее меню.
...
- Операции; включает подменю:
    ...
    - Заменить шаблон предпросмотра;
    - Восстановить шаблон предпросмотра.
- Дополнительно; включает подменю:
    - Соединить таблицы;
    - Создать векторный рисунок.
...
<img src="/GeomagDataDrawer/img/3_22_ru.png" />
...
Заданное количество строк будет рассматриваться программой именно как текст: данные из этих строк будут проигнорированы. Данное значение
...
программы. Следует отметить, что сохранение графических объектов возможно только в собственном формате программы (`.gdd`).
...
<img src="/GeomagDataDrawer/img/3_81_ru.png" />
...
## 3.1.7. “Извлечь из изображения”

Вызывает окно, позволяющее извлечь данные из изображения. Перед этим пользователь должен
выбрать файл изображения для извлечения.

<img src="/GeomagDataDrawer/img/3_82_ru.png" />

Пользователь может использовать левую и правую кнопки мыши, чтобы указать концы контрольного отрезка.
Линия, которую перекрывает полученный отрезок, будет использоваться для извлечения цветовой информации,
которая, в свою очередь, будет служить источником данных для построения диаграммы.

> ***Все несохраненные данные будут утеряны, если пользователь согласится с соответствующим предупреждением***

[:arrow_double_up:](#contents)

---

## 3.1.8. «Настройки программы»

Вызывает окно настроек программы.

<img src="/GeomagDataDrawer/img/3_17_ru.png" />
...
<img src="/GeomagDataDrawer/img/3_21_ru.png" />
...
<img src="/GeomagDataDrawer/img/3_63_ru.png" />
...
<img src="/GeomagDataDrawer/img/3_40_ru.png" />
...
в настройках ОС. Нечисловые значения (точки разрыва) должны вводиться словом `NaN` (с учётом регистра).

Обо всех ошибках при заполнении ячеек таблицы пользователь извещается или сразу при попытке покинуть ячейку, или при попытке
...
- Перемещение текущей выбранной строки на одну позицию вверх (кнопка <img src="/GeomagDataDrawer/img/3_41.png" />).
В качестве текущей здесь и далее выступает последняя выделенная строка.
- Перемещение текущей выбранной строки на одну позицию вниз (кнопка <img src="/GeomagDataDrawer/img/3_42.png" />).
- Добавление строки перед текущей выбранной (кнопка <img src="/GeomagDataDrawer/img/3_43.png" />).
- Добавление строки после текущей выбранной (кнопка <img src="/GeomagDataDrawer/img/3_44.png" />).
- Удаление выбранных строк (кнопка <img src="/GeomagDataDrawer/img/3_45.png" />).
...
[параметрического добавления кривых](#section-26).
...
3 6 7 2 3 2
```
Результат будет зависеть от выбранных настроек.

[:arrow_double_up:](#section)

---

## 3.3.2. «Создать векторный рисунок»
...
данных Microsoft Office Excel. Приложение может функционировать без поддержки этого формата (без этих библиотек).
...
## 4.5. Работа с программой из командной строки
...
Символы `0` – `9`, `-`, латинские `e` и `E`, `.` и `,` считаются элементами
