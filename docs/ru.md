...
> **ƒ** &nbsp;Nicolay B. aka RD_AAOW, Соля́ников Я.; 11.02.2024; 20:28
...
- [Меню программы](#section-14)
    ...
    - Дополнительно
    - [«Соединить таблицы»](#section-38)
    - [«Создать векторный рисунок»](#section-39)
    - Помощь
    - [«О программе / справка»](#section-41)
    - [Пункт меню с выбором языка интерфейса](#section-42)
    - [«Ассоциировать файлы»](#section-43)
- [Аппаратно-программные требования и комплектация программы](#section-44)
    - Комплектация программы
    - [Создаваемые файлы и директории](#section-46)
    - [Поддерживаемые форматы данных](#section-47)
    - [Поддержка форматов Microsoft Office Excel](#microsoft-office-excel)
    - [Работа с программой из командной строки](#section-48)
- [Ограничения и стандартные значения параметров](#section-49)
- [Спецификации форматов файлов](#section-50)
    ...
    - [Файлы, из которых необходимо извлечь данные](#section-51)
